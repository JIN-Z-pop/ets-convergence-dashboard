...
- **gods-eye-db** (48 tables, ~26,300 rows): `raw_cea_daily`, `raw_kets_daily_price`, `ets_system_comparison`, `ets_allocation_typology`, `eu_ets_phases`, `japan_gx_ets_timeline`, `eu_ets_cbam_timeline`, `ets_terminology`
- **Knowledge Brain RAG** (1,600+ items): ETS analysis, CBAM documents, convergence insights
...
# Exports 5 JSON files to data/ from gods-eye-db
```
